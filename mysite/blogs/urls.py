...
# @Last Modified time: 2017-05-06 17:32:07
...
urlpatterns = [
	...
	url(r'^articlesorderby/$', views.articlesorderby, name='articlesorderby'),
	url(r'^fictionorderby/(?P<id>\d+)/$', views.fictionorderby, name='fictionorderby'),
